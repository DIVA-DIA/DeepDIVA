...
def validate(val_loader, model, criterion, writer, epoch, no_cuda, log_interval=20, **kwargs):
...
def test(val_loader, model, criterion, writer, epoch, no_cuda, log_interval=20, **kwargs):
